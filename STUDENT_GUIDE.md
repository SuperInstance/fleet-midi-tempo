# Student Guide: fleet-midi-tempo

_Learn how the tempo agent works and how to use it._

---

## What You'll Learn

1. What the tempo musical concept is
2. How ternary decomposition applies to tempo
...
```bash
curl -s http://localhost:2163/health | python3 -m json.tool
```
...
```bash
curl -s -X POST http://localhost:2163/agent \
